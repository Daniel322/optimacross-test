...
export class CommandsService {
  ...
  help(): void {
    console.log(`
      ...
      - ${chalk.green('get cars')} with arguments: -${chalk.green('brand')}=value(${chalk.red('required')}) -${chalk.green('sort')}=name | price | yearOfCreated(optional) -${chalk.green('sortType')}=asc | desc(optional)
